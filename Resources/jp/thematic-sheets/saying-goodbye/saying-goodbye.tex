...
\begin{tikzpicture}[overlay]
	...
	\node[anchor=south east] at (3,-1.15) {\includegraphics[width=3cm]{images/nicubunu-Comic-characters-Bye-200px.png}};
\end{tikzpicture}\vspace{15mm}
	
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

Il y a plusieurs façons de dire \textit{au revoir} en japonais, qui dépendent du type d'au revoir et de la personne à qui on s'adresse. De manière générique, on utilise さようなら \romaji{say\=onara} pour dire au revoir.

% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

\sectit{Selon la situation}

La première distinction qu'on peut faire concerne le type d'au revoir que l'on fait. Cette nuance ainsi apportée est importante au Japon, car elle apporte plus d'informations qu'un simple au revoir.
