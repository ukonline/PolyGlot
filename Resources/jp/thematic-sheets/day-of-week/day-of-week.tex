...
\begin{tikzpicture}[overlay]
    ...
    \node[anchor=south east] at (2.5,-1.15) {\includegraphics[width=2cm]%
    {images/dayCalendar-200px.png}};
...
Au Japon, le premier jour de la semaine est le dimanche et il est associé au
soleil. Les autres jours sont respectivement associés aux éléments suivants :

\begin{tabular}{*{7}{@{\qquad}c}}
    \Huge日 & \Huge月 & \Huge火 & \Huge水 & \Huge木 & \Huge金 & \Huge土 \\
...
On remarquera que 日 se prononce \romaji{hi} lorsqu'il est utilisé seul, mais
\romaji{bi} dans 曜日.
