...
On peut écrire les nombres avec la notation arabe (1, 2, 3) ou la chinoise (一,
二, 三). La première notation est plus souvent utilisée lorsqu'on écrit
horizontalement et la seconde lorsqu'on écrit verticalement. Dans certain cas,
pour des documents officiels notamment, on utilisera d'office la notation
chinoise. Concernant la lecture, lorsqu'il s'agit de compter (nombre cardinal),
on utilise généralement la prononciation \textit{on}'.
